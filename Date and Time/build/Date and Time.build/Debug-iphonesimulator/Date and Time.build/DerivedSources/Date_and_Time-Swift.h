...
SWIFT_MODULE_NAMESPACE_PUSH("Date_and_Time")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC13Date_and_Time11AppDelegate")
...
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified Label2;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified timeZone;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified timeZone2;
- (void)viewDidLoad;
